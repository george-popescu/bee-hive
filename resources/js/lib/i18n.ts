...
const romanianMessages = {
    ...
    'Previous person': 'Persoana anterioară',
    'Next person': 'Persoana următoare',
    'Planning note': 'Notă de planificare',
    'This project is already allocated.': 'Acest proiect este deja alocat.',
    'Leave + holidays': 'Concediu + sărbători',
    ':hours over capacity; saving is still allowed.':
        ':hours peste capacitate; salvarea este permisă.',
    'W:week · :date': 'S:week · :date',
    'Remove allocation': 'Elimină alocarea',
    'No allocations for this person and month.':
        'Nu există alocări pentru această persoană și lună.',
    'Add project': 'Adaugă proiect',
    'Select a project': 'Selectează un proiect',
    ':hours available': ':hours disponibile',
    'Unsaved changes.': 'Modificări nesalvate.',
    'No unsaved changes.': 'Nu există modificări nesalvate.',
    Discard: 'Renunță',
    'Saving...': 'Se salvează...',
    'Recent changes': 'Modificări recente',
    'No allocation changes recorded yet.':
        'Nu există încă modificări de alocare înregistrate.',
    'allocation.upserted': 'alocare creată',
    'allocation.updated': 'alocare actualizată',
    'allocation.deleted': 'alocare ștearsă',
